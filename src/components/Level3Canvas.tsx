    ...
    <div className="relative w-full h-full overflow-hidden bg-black">
      ...
      <div className="absolute top-6 left-6 flex gap-4 z-10">
        <div className="bg-red-900/80 border-2 border-red-500 px-4 py-2 rounded-lg shadow-[0_0_15px_rgba(255,0,0,0.5)]">
            <span className="text-yellow-400 font-bold text-xl">🍌 {state.bananas}</span>
        </div>
        <div className="bg-yellow-900/80 border-2 border-yellow-500 px-4 py-2 rounded-lg shadow-[0_0_15px_rgba(255,180,0,0.5)]">
            <span className="text-white font-bold text-xl">💰 {state.coins}</span>
        </div>
